        ...
        <div class="snz-write-section">
            ...
            <div class="write-select-info">
                    ...
                    <div class="enter-category">
                        ...
                        <div class="dropdown">
                            <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-expanded="false">
                                <span class="selected-item" id="cate_nm">
		                            <c:choose>
                    ...
                    <div class="enter-title">
                        <label for="">제목</label>
                        <input type="text" id="title" name="title" placeholder="제목을 입력하세요." value="${info.title }"/>
                    </div>
            </div>
            <div class="write-form">
                ...
                <div class="enter-content">
                    <textarea name="cntn" id="cntn" cols="30" rows="10" style="width:95%;min-width:260px; height:412px; display:none;" placeholder="내용을 입력해주세요">
                    	${info.cntn }
                    </textarea>
                </div>
					...
					<div class="fileBox">
						<c:forEach items="${f_list}" var="f" varStatus="g">
							<span style="margin-right:5px" id="file-span${g.index}">
								${f.file_nm}
								<a href="javascript:file_del('${f.lec_board_file_no }','${g.index}')"><span class="search-btn"><img src="common/img/page/x.png" alt=""/></span></a>
							</span>
